...
// gui.add(parameters, 'size').min(0.001).max(0.1).step(0.001).name('star size').onChange(generateGalaxy)
gui.add(parameters, 'size').min(0.001).max(0.1).step(0.001).name('star size').onFinishChange(generateGalaxy)
// gui.add(parameters, 'radius').min(0.001).max(0.1).step(0.001).name('galaxy radius').onChange(generateGalaxy)
gui.add(parameters, 'radius').min(0.01).max(20).step(0.01).name('galaxy radius').onFinishChange(generateGalaxy)

//gui.add(parameters, 'branches').min(2).max(20).step(1).name('branches').onChange(generateGalaxy)
